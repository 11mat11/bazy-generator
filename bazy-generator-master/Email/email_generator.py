...
from Imiona.imie_generator import generuj_imie
from Nazwiska.nazwisko_generator import generuj_nazwisko
...
def wczytaj_domain_extensions():
    ...
    if not kombinacje:
        with open("Email/domain_extensions.csv", encoding="utf-8") as f:
